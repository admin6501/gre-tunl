...
**GRE TUNL** یک ابزار قدرتمند و کاربرپسند برای مدیریت تونل‌های GRE با قابلیت فورواردینگ پورت توسط HAProxy است. این اسکریپت به شما امکان می‌دهد به راحتی تونل‌های امن بین سرور ایران و خارج راه‌اندازی کنید.
...
| Ports | پورت‌های Forward | `443,8080` |
...
- 🐛 **گزارش باگ:** [Issues](https://github.com/admin6501/gree-tunl/issues)
- 💬 **سوالات:** [Discussions](https://github.com/admin6501/gree-tunl/discussions)
